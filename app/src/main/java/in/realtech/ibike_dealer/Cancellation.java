...
public class Cancellation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //new Asynccancel().execute();
    }
//    private class Asynccancel extends AsyncTask<String, String, String> {
...
//
//        public Asynccancel(Panel_Model root_response, String s,
//                           Service_Panel_Adapter.MyViewHolder holder) {
...
//
//                url = new URL(" http://65.0.207.184/service/api/dealer_app_api");
//
...
//                        .appendQueryParameter("cancel_reason", mPanel.getCancel_reason());
//
//
